...
public class ActivityHorario extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        turmasProfessor = new RepositorioUsuario().getTurma();

        Log.e("TURMAS", turmasProfessor[0]);
        setContentView(R.layout.activity_horario);
        spinner = (Spinner) findViewById(R.id.spn);

        ArrayList<String> spinnerArray = new ArrayList<String>();
        for (int i =0;i<=10;i++){
            if(turmasProfessor[i] != null){
                spinnerArray.add(turmasProfessor[i]);
            }else
                break;
        }
    ...
    public void Avancar(View view){
        ...
        Bundle a = new Bundle();
        a.putString("turma", turma);
        Intent  intent = new Intent(getApplicationContext(), ActivityHorarioVisualizar.class);
        intent.putExtras(a);
...
//                url = strings[1];
        ...
        protected void onPostExecute(String s) {
            ...
            try{
                ...
                new GetHorarios().execute("https://suap.ifrn.edu.br/api/v2/minhas-informacoes/boletim/"+new RepositorioUsuario().getCaminhoPeriodo());
            }catch (Exception e){
                e.printStackTrace();
            }
        }
