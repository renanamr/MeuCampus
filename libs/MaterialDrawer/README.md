...
the dev can choose his own implementation (Picasso, Glide, ...). This has to be done, before the first data should be loaded via URL. (Should be done in the Application, but any other spot before loading the first data is working too)
...
###Code:
```java
//initialize and create the data loader logic
